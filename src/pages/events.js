      ...
      <div className="page-goes-here">
        <div className="textArea">
          <div className="event">
            ...
            <p>
              Ear Camera is | est:
              Tommy Davis // Suzu Enns // India Gailey // Joseph Glaser // Noa Haran // Justin Jaramillo // Michael Kim-Sheng // Francis Leduc-Bélanger // Michael Mansourati // Chris Paul // James Rubino // Keith Stratton
            </p>
          </div>
        </div>
      </div>
